    ...
    <div id="all">
        <div class="wrapper">
            <div class="main">
				...
				<div class="content">
					<div class="content-top">				
							...
							<ul>
								<li>
									McatCloud 最新官网地址
									<a href="https://skr.bar" target="_blank"><i>https://skr.bar</i></a>
								</li>
								<li>
									最新跳转地址
									<a href="https://srk.rest" target="_blank"><i>https://srk.rest</i></a>
								</li>
								<li>
									官网订阅转换工具
									<a href="https://sua.srt.bar/" target="_blank"><i>https://sua.srt.bar/</i></a>
								</li>

								<li>
                                				<a>如无法正常打开，请稍后再获取打开，建议使用Chrome浏览器打开</a>
								</li>
								<br/>
								<br/>
				...
				<p class="footer">© 2018-2022 Alejandro. All Rights Reserved</p>
			</div>
					<br/>
					<br/>
					<br/>
