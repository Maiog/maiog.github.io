...
<head>
    ...
    <link rel="shortcut icon" href="https://avatars3.githubusercontent.com/u/38198082?s=460&u=e2da43cada61d365f96c9b280d46482e7b2510b8&v=4" /> 
    <title>导航页面</title>
				...
				<div class="content">
					<div class="content-top">				
							...
							<ul>
								<li>
									负负得正（disnot.com）
									<a href="https://disnot.com" target="_blank"><i>https://disnot.com</i></a>
									</span></span>
								</li>
								<li>
									Gitee
									<a href="https://gitee.com/wrongcode" target="_blank"><i>https://gitee.com/wrongcode</i></a>
									</span></span>
								</li>
								<li>
									GitHub
									<a href="https://github.com/realwds" target="_blank"><i>https://github.com/realwds</i></a>
									</span></span>
								</li>

								<li>
                                <span>近期部分国产浏览器屏蔽网址<span>
							</ul>
							
					</div>
				</div>
				<p class="footer">© 2018-2020 Alejandro. All Rights Reserved</p>
			</div>	
            <ul class="bg-bubbles">
                <li></li>
                <li></li>
